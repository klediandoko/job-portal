...
public class ApplicationService {
    ...
    public List<ApplicationResource> getAllApplicationsByJobId(Long jobId) {
        return applicationMapper.applicationsToApplicationResources(
                applicationRepository.findAllByJob_Id(jobId));
    }
    ...
    public Page<ApplicationResource> getMyApplicationsAndFilters(
            Long userId, String applicationStatus, String jobTitle, int page, int size) {
        PageRequest pageRequest = PageRequest.of(page, size);
        Page<Application> applicationsPage = applicationRepository.findAllByUserAndFilters(
                userId, applicationStatus, jobTitle, pageRequest);
